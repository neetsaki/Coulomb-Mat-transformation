...
#get CM
    ...
    supply = Chem.SDMolSupplier(filepath+'.sdf')
    ...
    [Chem.Kekulize(mol) for mol in supply]
    s=[Chem.MolToSmiles(mol,kekuleSmiles=True) for mol in supply]
    c=map(smi2cm,s)
    #while 10000<n<=20000:
    #for mol in supply:
        #if total>n:
